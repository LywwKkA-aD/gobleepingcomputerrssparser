...
import (
	...
	"github.com/LywwKkA-aD/gobleepingcomputerrssparser/internal/config"
	"github.com/LywwKkA-aD/gobleepingcomputerrssparser/internal/models"
	"github.com/LywwKkA-aD/gobleepingcomputerrssparser/internal/repository"
	"github.com/LywwKkA-aD/gobleepingcomputerrssparser/internal/service/rss"
...
func (b *Bot) formatNewsMessage(item models.NewsItem) tgbotapi.MessageConfig {
	...
	if len(item.Categories) > 0 {
		hashtags = "\n\n🏷️ " + formatCategories(item.Categories)
	}
